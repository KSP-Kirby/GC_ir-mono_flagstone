...
for smoothingFactor = [80]                                        % this smooths between depth labels 
    for dataFactor = [400]                                        % for nice smooth along a single line, 15, 400, 40, 0 works well
        for horzNeighborMaskWeight = [40]
            for verticalNeighborMaskWeight = [2]
                ...
                labels = (minLabel:10:maxLabel)*10;  %*10 converts from cm to mm
...
%                 save(filename,'depthMap');  
    ...
    ((depthMap(120,170)+minLabel-30)*10*ir(120,170)/(6.2791/.006))-20
    toc
end
